...
export class PsbComponent implements OnInit {
  ...
  openActivation(item: PsbOrder) { this.selected.set(item); this.activationStep.set(1); this.odpPickerOpen = false; this.odpSearch = ''; this.activation = { username: item.customerId, password: item.customerId, odp: '', routerNasId: '', installationPhoto: '' }; this.activationOpen.set(true); }
