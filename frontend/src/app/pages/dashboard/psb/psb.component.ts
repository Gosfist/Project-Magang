...
export class PsbComponent implements OnInit {
  ...
  form = { customerName: '', phone: '', idCardNumber: '', idCardPhoto: '', address: '', pppoePackageId: '', areaId: '' };
  ...
  openForm(item?: PsbOrder) { this.editing.set(item || null); this.form = item ? { customerName: item.customerName, phone: item.phone, idCardNumber: item.idCardNumber || '', idCardPhoto: item.idCardPhoto || '', address: item.address, pppoePackageId: item.pppoePackageId, areaId: item.areaId || '' } : { customerName: '', phone: '', idCardNumber: '', idCardPhoto: '', address: '', pppoePackageId: '', areaId: '' }; this.formOpen.set(true); }
