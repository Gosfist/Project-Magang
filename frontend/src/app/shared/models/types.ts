...
export type PsbOrder = {
  id: string; customerNumber: string; customerId: string; customerName: string; phone: string; address: string; idCardNumber?: string | null; idCardPhoto?: string | null;
