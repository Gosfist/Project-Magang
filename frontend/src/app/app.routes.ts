...
export const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent },
  {
    ...
    children: [
      ...
      { path: 'monitoring/server', loadComponent: () => import('./pages/dashboard/monitoring/server/server.component').then((m) => m.ServerMonitoringComponent), canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      { path: 'monitoring/router', loadComponent: () => import('./pages/dashboard/monitoring/router/router-monitoring.component').then((m) => m.RouterMonitoringComponent), canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      { path: 'monitoring/radius', loadComponent: () => import('./pages/dashboard/monitoring/radius/radius-monitoring.component').then((m) => m.RadiusMonitoringComponent), canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      ...
      { path: 'pppoe/paket-layanan', component: PaketLayananComponent, canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      { path: 'pppoe/data-pelanggan', component: DataPelangganComponent, canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      { path: 'pppoe/ip-pools', loadComponent: () => import('./pages/dashboard/pppoe/ip-pools/ip-pools.component').then(m => m.IpPoolsComponent), canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      { path: 'router/routers', loadComponent: () => import('./pages/dashboard/router/routers/routers.component').then(m => m.RoutersComponent), canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      { path: 'router/vpn-server', loadComponent: () => import('./pages/dashboard/router/vpn-server/vpn-server.component').then(m => m.VpnServerComponent), canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      { path: 'router/vpn-client', loadComponent: () => import('./pages/dashboard/router/vpn-client/vpn-client.component').then(m => m.VpnClientComponent), canActivate: [roleGuard('admin', 'sales', 'petugas')] },
      { path: 'tools/kalkulator-redaman', component: KalkulatorRedamanComponent, canActivate: [roleGuard('admin', 'sales', 'petugas')] },
