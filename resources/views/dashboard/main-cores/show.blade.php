...
@section('page-title', 'Detail Closure')
@section('content')
<div class="mb-6"><a href="{{ route('main-cores.index') }}" class="text-sm text-blue-600 hover:underline">← Kembali ke Data Closure</a></div>
<div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        ...
        <div><span class="text-gray-500">Lokasi:</span> <span class="font-medium text-gray-900 ml-1">{{ $mainCore->start_location ?? '-' }}</span></div>
...
<div class="bg-white rounded-lg border border-gray-200 p-6">
    <h3 class="font-semibold text-gray-900 mb-4">Input Redaman yang Menggunakan Closure Ini</h3>
