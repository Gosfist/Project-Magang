...
<div class="bg-white border border-gray-200 rounded-lg overflow-x-auto">
    <table class="w-full text-sm">
        <thead class="bg-gray-50 text-gray-500"><tr><th class="text-left px-5 py-3">Core</th><th class="text-left px-5 py-3">Warna</th><th class="text-left px-5 py-3">Redaman</th><th class="text-left px-5 py-3">Endpoint A</th><th class="text-left px-5 py-3">Endpoint B</th><th class="text-left px-5 py-3">Catatan</th></tr></thead>
        <tbody>
            @foreach($cable->cores as $core)
                ...
                <tr class="border-t">
                    ...
                    <td class="px-5 py-3">{{ $core->warna_core ?? '-' }}</td>
