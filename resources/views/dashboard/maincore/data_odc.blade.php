...
@section('content')
    @php
        ...
        $ratioOptions = \App\Models\MainCore::ODC_RATIOS;
    @endphp
            ...
            <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                <div class="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 px-5 py-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <input id="odcSearch" data-table-search type="search" placeholder="Cari nama ODC..."
                    ...
                    <table class="w-full bg-white text-sm">
                        ...
                        <tbody id="nodeRows" class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr class="bg-white" data-node-row="{{ $node->id }}" data-odc-row data-filter-row
                                    ...
                                    <td class="px-5 py-3">
                                        <div class="flex justify-end gap-2 whitespace-nowrap">
                                            ...
                                            <form data-maincore-form data-confirm="Yakin ingin menghapus data ini?"
                                                method="POST"
                            ...
                            <tr id="noOdcSearchResults" data-filter-empty class="hidden">
                                <td colspan="6" class="px-5 py-8 text-center text-gray-400">Nama ODC tidak ditemukan.
                                </td>
                            </tr>
                        </tbody>
                    </table>
