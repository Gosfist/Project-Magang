        ...
        <div class="overflow-hidden rounded-lg border border-gray-200 bg-white">
            <div class="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 px-5 py-4">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <input id="rasioSearch" data-table-search type="search" placeholder="Cari nama rasio..."
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody id="nodeRows">
                        @forelse($nodes as $node)
                            <tr class="border-t border-gray-100" data-node-row="{{ $node->id }}" data-rasio-row data-filter-row
                        ...
                        @endforelse
                        <tr id="noRasioSearchResults" data-filter-empty class="hidden">
